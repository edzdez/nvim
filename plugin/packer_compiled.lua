...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-cmdline", "cmp-nvim-ultisnips", "cmp-omni", "cmp-path", "cmp-nvim-lua", "cmp-nvim-lsp", "cmp-buffer" },
...
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'lspkind-nvim', 'whitespace.nvim', 'which-key.nvim', 'lualine.nvim', 'vim-sandwich', 'bufferline.nvim', 'vim-indent-object'}, { event = "VimEnter *" }, _G.packer_plugins)]]
